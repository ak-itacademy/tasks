...
def calculate_32_zero_bits(value: int) -> int:
    ...
    counter += 1
    return counter
или return sum(map(lambda index: value & (1 << index) != 0, range(32)))
...
def event_and_match_interval_m10_10(value: int) -> bool:
    return vallue % 2 == 0 and -10 < value < 10
